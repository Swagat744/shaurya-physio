  ...
  return (
    <aside className="w-64 min-h-screen bg-slate-900 flex flex-col">
      ...
      <div className="px-6 py-6 border-b border-slate-800">
        ...
        <p className="text-xs text-slate-500 mt-0.5 font-sans">Clinic Management</p>
      </div>
      ...
      <div className="px-4 py-4 border-t border-slate-800">
        ...
        <div className="mt-3">
          <Link
            href="/"
            className="block text-xs text-slate-500 hover:text-primary-400 transition-colors"
          >
            View Public Site
          </Link>
        </div>
